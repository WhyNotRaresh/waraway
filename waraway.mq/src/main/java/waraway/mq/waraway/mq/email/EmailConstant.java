...
public class EmailConstant {
    ...
    public static final String USERNAME = "subscribe.waraway@gmail.com";
    public static final String PASSWORD = "Waraway2022!";
    public static final String FROM_EMAIL = "support@getarrays.com";
    public static final String CC_EMAIL = "";
    public static final String EMAIL_SUBJECT = "WARAWAY SUBSCRIPTION";
